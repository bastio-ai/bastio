...
-- =============================================================================
-- Members + invitations: moved to bastio-cloud (multi-user is a cloud-only
-- feature). See bastio-cloud/pkg/migrations/migrations/004_workspace_members.sql.
-- The OSS workspace runs single-tenant single-user and never references
-- these tables.
-- =============================================================================
