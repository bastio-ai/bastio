...
export type WorkspaceExtension = {
  ...
  // Extra buttons rendered in the Dashboard tab's "Quick actions"
  // panel after the OSS-shipped buttons (Start new chat, View
  // analytics). Cloud injects "Invite members" + "Team settings"
  // here; OSS leaves it null and the panel ends after View analytics.
  quickActions: ReactNode;

  // Extra section(s) appended to the Settings tab after the LLM
  // models card. Cloud renders the seat-limit / retention /
  // billing-mode / branding form here (cloud-only fields backed by
  // the Stripe webhook, retention policy, branded-chat feature). OSS
  // leaves this null.
